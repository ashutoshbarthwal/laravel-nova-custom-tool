...
var update = __webpack_require__(15)("290c3e45", content, false, {});
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get("https://api.exchangeratesapi.io/latest?base=INR").then(function (response) {
                                    _this.rates = response.data.rates;
                                    _this.data = {
                                        "INR/USD": _this.rates.USD,
                                        "INR/GBP": _this.rates.GBP,
                                        "INR/EUR": _this.rates.EUR
                                    };
                                });
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Exchange Rate Tracker")]),
      _vm._v(" "),
      _c(
        "card",
        {
